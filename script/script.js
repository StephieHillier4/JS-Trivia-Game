document.addEventListener('DOMContentLoaded', () => {
    ...
    const questions = {
        ...
        elaine: [
            {question: "What was Elaine's full name?", answers: ["Elaine Louis Dreyfus", "Elaine Betty D", "Elaine Cheryl Bennett", "Elaine Marie Benes"], correct: 3},
            ...
            {question: "What body part of Elaine's body did Kramar expose in a Christmas Photo?", answers: ["hip", "nipple", "buttox", "thigh"], correct: 1},
            ...
            {question: "What was Elaine's profession?", answers: ["Nurse", "Editor", "Accountant", "Librarian"], correct: 1},
        ], 
        george: [
            ...
            {question: "What body part did George get hired to model?", answers: ["feet", "hands", "eyes", "legs"], correct: 1},
        ...
        kramer: [
            {question: "What was Kramer's full name?", answers: ["Willis Kramer", "Harris Kramer", "Cosmo Kramer", "Astrid Kramer"], correct: 2},
            {question: "Who was Kramer's mom?", answers: ["DeeDee", "Billie", "Babbs", "Kiki"], correct: 2},
            {question: "What real life sit com did Kramer get hired on as a receptionist?", answers: ["Friends", "Who's the Boss", "Cheers", "Murphy Brown"], correct: 3},
            {question: "What major modeling company did Kramer do an underwear ad for?", answers: ["Calvin Klein", "Polo", "Guess", "Ambercombie and Fitch"], correct: 0},
            {question: "What was the name of Kramer's friend he often made reference to in the show?", answers: ["Luke Windthorpe", "Bob Sacamento", "Luthur Gilfried", "Blake Thorpe"], correct: 1},
            {question: "What piece of furniture did Kramer publish a book on?", answers: ["coffee table", "armoir", "curio cabinet", "couch"], correct: 0},
            {question: "What city did Kramer move to after the 'key' incident with Jerry?", answers: ["Las Vegas", "Los Angeles", "Atlanta", "San Fransico"], correct: 1},
            {question: "What major crime was Kramer once committed of but later excused from?", answers: ["arson", "extortion", "theft", "murder"], correct: 3},
            {question: "Who was Kramer's arch nemesis?", answers: ["Loony Toons Phil", "Psycho Stan", "Crazy Joe Divola", "Nut Job Ned"], correct: 2},
            {question: "How did Kramer burn down the cabin of George's finacee's father?", answers: ["matches", "cigar", "candle", "BBQ lighter"], correct: 1},
        ]
    }

    const bonusQuestions = {
        jerry: [
            {question: "What was Jerry's proper full name (first, middle, and last) in the Seinfeld sitcom?", answer: "Jeremiah Thomas Seinfeld"}
        ],
        elaine: [
            {question: "What was the name of the store where Elaine bought her favorite pair of shoes?", answer: "Boticellis"}
        ],
        george: [
            {question: "What was George's secret PIN code?", answer: "Bosco"}
        ],
        kramer: [
            {question: "What was the name of the cologne that Kramer created which was later stolen by Calvin Klein and renamed Ocean?", answer: "The Beach"}
        ]
    };
...
bonusButton.addEventListener("click", () => {
    if (bonusQuestionActive) {
        alert("You're already in Bonus Mode!"); 
    } else if (bonusQuestionsLeft > 0) {
        bonusQuestionsLeft--; 
        bonusQuestionActive = true; 
        alert("You're now in Bonus Mode! Double points for correct answers, but one wrong answer ends the game! Please choose a character.");
...
if (!gameStarted) {
    ...
    function displayQuestion(characterQuestions, character) {
        ...
        if (!questionData || questionIndex >= characterQuestions.length) {
            ...
            setTimeout(() => {
                alert(`All questions for ${character} have been answered! Please choose another character.`);
        ...
        questionData.answers.forEach((answer, index) => {
            ...
            answerButton.addEventListener('click', () => {
                checkAnswer(index, questionData.correct, characterQuestions, questionIndex, character);
            });
            answersContainer.appendChild(answerButton);
        });
    }

    function checkAnswer(selectedIndex, correctIndex, characterQuestions, questionIndex, character) {
        ...
        if (selectedIndex === correctIndex) {
            ...
            wrongAnswers += 1;
            score -= 5;
            message.textContent = "Sorry wrong answer, maybe you should try 'Friends' trivia instead!";
        ...
        function displayLoseGameMessage() {
            ...
            loseMessage.textContent = "Game Over! You've lost! Click the Start Seinfeld Trivia button to try again!";
        ...
        if (score >= 40 && !document.querySelector('.win-message')) {
            ...
            winMessage.textContent = "Congratulations! You've won the game! 🎉 Hit Start Seinfeld Trivia Game to play again!";
